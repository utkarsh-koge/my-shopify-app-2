...
export const action = async ({ request }) => {
  try {
    ...
    const flag = JSON.parse(formData.get("flag"));
  ...
  const handleCsvUpload = (e) => {
    ...
    Papa.parse(file, {
      ...
      complete: (res) => {
        ...
        if (rows.length > 5000) {
          alert("CSV contains more than 5,000 records. Please upload a smaller file.");
          return;
        }
        ...
        >
          ...
          <div className="flex gap-2 mb-2">
            ...
            <button
              ...
              className="bg-gray-200 hover:bg-gray-300 text-black px-4 py-2 rounded-md transition disabled:opacity-50"
            >
              +
            </button>
          </div>
