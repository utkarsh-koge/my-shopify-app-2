    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: (
                <div>
                    <p className="mb-3">
                        <strong>Metafield Clear</strong> allows you to bulk delete metafield definitions and their values. This is useful when you want to clean up unused data or reset specific fields.
                    </p>
                    <div className="flex items-start gap-2 text-sm bg-blue-50 text-blue-800 p-3 rounded-md border border-blue-100">
                        <CheckCircle2 size={16} className="mt-0.5" />
                        <p>
                            Don't worry if you make a mistake! You can <strong>restore</strong> cleared metafields within <strong>24 hours</strong> using the History page.
                        </p>
                    </div>
                </div>
            ),
        },
        {
            ...
            answer: (
                <p>
                    The <strong>History</strong> page tracks all your bulk operations. You can view a log of what tags were added or removed, when the operation happened, and the status of each job. This helps you maintain an audit trail of changes made to your store data.
                </p>
            ),
        },
        {
            ...
            answer: (
                <div className="space-y-3">
                    <p>
                        Yes! We provide a <strong>one-time restore</strong> option for records that were removed within the last <strong>24 hours</strong>.
                    </p>
                    <div className="flex items-start gap-2 text-sm bg-blue-50 text-blue-800 p-3 rounded-md border border-blue-100">
                        <CheckCircle2 size={16} className="mt-0.5 flex-shrink-0" />
                        <p>
                            When you perform an undo operation, the record of the removal is also deleted from our database to keep your history clean.
                        </p>
                    </div>
                </div>
            ),
