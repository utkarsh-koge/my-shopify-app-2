...
export default function HomePage() {
  ...
  const modules = [
    {
      title: "Remove Tags",
      desc: "Remove tags from specific items or globally using search & filters.",
      route: "/remove-tags",
    },
    {
      title: "Bulk Add Tags",
      desc: "Upload CSV to add or remove tags from products in bulk.",
      route: "/add-tags",
    },
    {
      title: "Clear Metafields",
      desc: "Clear metafield values for selected object types.",
      route: "/metafield-clear",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-10 flex flex-col items-center relative"> {/* Added relative for button positioning */}
      ...
      <div className="absolute top-10 right-10 flex space-x-4">
        <button
          className="px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-200 transition-colors shadow-sm"
      ...
      <p className="text-gray-700 max-w-xl text-center mb-10">
        ...
        and clear metafield values in bulk from different resources.
      </p>
